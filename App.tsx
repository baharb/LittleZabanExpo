...
import VideoShowsScreen    from './src/screens/VideoShowsScreen';
import LetterTracingScreen from './src/screens/LetterTracingScreen';
...
function Router() {
  ...
  switch (screen.name) {
    ...
    case 'LetterTracing':    return <LetterTracingScreen />;
