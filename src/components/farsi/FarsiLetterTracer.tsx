...
export default function FarsiLetterTracer({
  ...
  const ghostSource = getGhostSource(letter.id);
...
function getGhostSource(letterId: string) {
  return neliWorldAssets.traceLetters?.[letterId as keyof typeof neliWorldAssets.traceLetters] ?? null;
}
