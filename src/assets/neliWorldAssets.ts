...
export const roomBackgroundPickers = {
  ...
  kitchen: (width: number, height: number) => pickRoomBackground(kitchenBackgrounds.colorfulAndCozy, width, height),
} as const;
...
export const neliWorldAssets = {
  ...
  foods: {
    ...
    fish: require('../../assets/neli-world/food-flat/fish.png'),
  ...
  rooms: {
    ...
    cookingTable: kitchenBackgrounds.colorfulAndCozy.universal,
    cookingTableTabletLandscape: kitchenBackgrounds.colorfulAndCozy.tabletLandscape,
    cookingTableTabletPortrait: kitchenBackgrounds.colorfulAndCozy.tabletPortrait,
    feedAnimalsJungle: playgroundBackgrounds.universal,
    feedAnimalsJunglePortrait: playgroundBackgrounds.phone,
    feedAnimalsJungleTabletLandscape: playgroundBackgrounds.tabletLandscape,
    feedAnimalsJungleTabletPortrait: playgroundBackgrounds.tabletPortrait,
    bedroom: bedroomBackgrounds.final.universal,
    garden: yardBackgrounds.universal,
    kitchen: kitchenBackgrounds.colorfulAndCozy.universal,
