...
export const neliWorldAssets = {
  ...
  bathroom: {
    ...
    clothes: {
      ...
      backpack: require('../../assets/neli-world/clothes/backpack.png'),
      ...
      book: require('../../assets/neli-world/clothes/book.png'),
  ...
  ui: {
    ...
    trainHead: require('../../assets/neli-world/ui-icons/trainhead.png'),
  },
} as const;
