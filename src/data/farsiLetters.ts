...
const SAD = TRACE.sad;
// Sad is traced in two parts: first the small oval/drop section, then the open half-circle body.
const SAD_DROP = 'M 90.3 89.0 C 98.2 85.6 104.7 89.7 105.4 97.9 C 106.2 106.4 101.0 114.7 92.7 117.0 C 84.8 119.1 76.9 115.9 72.8 108.8 C 68.6 101.5 69.5 92.7 75.1 87.3 C 80.5 82.1 87.0 81.2 90.3 89.0';
...
export const FARSI_LETTERS: FarsiLetter[] = [
  ...
  { id: 'be',    letter: 'ب', nameFa: 'ب',             nameEn: 'Be',    exampleFa: 'بره',   exampleEn: 'Lamb',      exampleIcon: '??', viewBox: VB, outlinePath: OUTLINES['be'],   color: '#FF8B2B', strokes: [s('main', BE, 1)], dots: [{ x: 100, y: 146.4 }] },
  { id: 'pe',    letter: 'پ', nameFa: 'پ',             nameEn: 'Pe',    exampleFa: 'پروانه', exampleEn: 'Butterfly', exampleIcon: '??', viewBox: VB, outlinePath: OUTLINES['pe'],   color: '#9B5CFF', strokes: [s('main', PE, 1)], dots: [{ x: 86.2, y: 132.2 }, { x: 99.6, y: 151 }, { x: 113, y: 132.2 }] },
  { id: 'te',    letter: 'ت', nameFa: 'ت',             nameEn: 'Te',    exampleFa: 'پرتقال', exampleEn: 'Ball',      exampleIcon: '?', viewBox: VB, outlinePath: OUTLINES['te'],   color: '#4CC9F0', strokes: [s('main', TE, 1)], dots: [{ x: 87, y: 53.3 }, { x: 111.1, y: 53.3 }] },
  { id: 'se',    letter: 'ث', nameFa: 'ث',             nameEn: 'Se',    exampleFa: 'ثانیه', exampleEn: 'Fox',       exampleIcon: '??', viewBox: VB, outlinePath: OUTLINES['se'],   color: '#FF6BB5', strokes: [s('main', SE, 1)], dots: [{ x: 99.6, y: 44.1 }, { x: 86.2, y: 63.2 }, { x: 113, y: 63.2 }] },
  ...
  { id: 'che',   letter: 'چ', nameFa: 'چ',             nameEn: 'Che',   exampleFa: 'چتر',    exampleEn: 'Umbrella',  exampleIcon: '??', viewBox: VB, outlinePath: OUTLINES['che'],  color: '#7A67FF', strokes: [s('main', CHE, 1)], dots: [{ x: 97.2, y: 105.1 }, { x: 111, y: 124 }, { x: 124.4, y: 105.1 }] },
  ...
  { id: 'zad',   letter: 'ض', nameFa: 'ض',             nameEn: 'Zad',   exampleFa: 'ضربدر', exampleEn: 'Beat',      exampleIcon: '??', viewBox: VB, outlinePath: OUTLINES['zad'],   color: '#EC4899', strokes: [s('main', SAD, 1, at([0.18, 0.46, 0.76]))], dots: [{ x: 113.6, y: 50.9 }] },
  ...
  { id: 'zaa',   letter: 'ظ', nameFa: 'ظ',             nameEn: 'Za',    exampleFa: 'ظرف',    exampleEn: 'Dish',      exampleIcon: '???', viewBox: VB, outlinePath: OUTLINES['zaa'],   color: '#8B5CF6', strokes: [s('main', TA, 1, at([0.3, 0.7]))], dots: [{ x: 110.9, y: 48.6 }] },
  ...
  { id: 'ghaf',  letter: 'ق', nameFa: 'ق',             nameEn: 'Qaf',   exampleFa: 'قلب',    exampleEn: 'Heart',     exampleIcon: '??', viewBox: VB, outlinePath: OUTLINES['ghaf'],  color: '#FF4D8C', strokes: [s('main', GHAF, 1, at([0.25, 0.65]))], dots: [{ x: 117.5, y: 29.1 }, { x: 139, y: 29.1 }] },
